...
def main():
    ...
    parser.add_argument('--convergance', type=str, default=None, help='Set the convergance criteria to one of the predefined choices', choices=['NWCHEM_LOOSE', 'GAU_LOOSE', 'TURBOMOLE', 'GAU', 'INTERFRAG_TIGHT', 'GAU_TIGHT', 'GAU_VERYTIGHT'])
